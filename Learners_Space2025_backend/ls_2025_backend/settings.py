...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-j@xg78+yi260r(s1^a+&rq$+zh!nig=z2$^4q@#5wu!u#j@w6n')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/day',
        'user': '1000/day',
        'signup_throttle': '5/min',
        'login_throttle': '10/min',
    }
}
